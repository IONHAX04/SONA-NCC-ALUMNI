      ...
      <IonContent fullscreen>
        <div className="flex flex-col h-full items-center justify-center px-6">
          ...
          <input
            type="email"
            placeholder="Email"
            className="mb-4 w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm"
          ...
          <input
            ...
            className="mb-2 w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm"
            style={{ marginBottom: "10px" }}
          />
          ...
          <p className="mt-6 text-sm text-gray-600">
            ...
            <button className="text-[#1173d4] font-semibold hover:underline">
              Sign up
            </button>
          </p>
        </div>
